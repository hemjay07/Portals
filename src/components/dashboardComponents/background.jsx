...
import { Container, StyledLabel, StyledHeader, StyledParagraph, StyledDesc, StyledRadio, StyledRadioHead } from "./formComponents.styled";
const techDivisions = [
  { label: "", value: "" },
  ...
  return (
    <Container>
      ...
      <StyledLabel>
        ...
        <br /> 
        <StyledDesc>Please include your title and company. 
        <br /> 
        For example, Microbiology
        student at University of Ibadan or Product Designer at Softcom Limited or Unemployed</StyledDesc>
        <input
          type="text"
      ...
      <StyledRadio>
        <StyledRadioHead>Where are you in your tech career now?</StyledRadioHead>
        <label>
          <input
            value="learning"
            name="status"
